(() => {
  ...
  const services = [
    { n: "01", title: "Compliance & Trust", sub: "Audit readiness \xB7 privacy \xB7 vendor risk", desc: "Policy work, controls design, evidence workflows, and remediation support shaped around the systems you actually run.", items: ["Audit prep & remediation", "Continuous monitoring", "Vendor risk programs", "Penetration testing"], accent: "var(--cobalt)", href: "service-compliance.html" },
  ...
  const capabilities = [
    ["Compliance", ["Audit readiness", "Privacy programs", "PCI remediation", "Data handling", "Vendor risk", "Security reviews", "Pentests"]],
