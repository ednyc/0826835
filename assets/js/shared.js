(() => {
  ...
  const Nav = ({ dark = true, current = "" }) => {
    ...
    }), /* @__PURE__ */ React.createElement("div", { style: { paddingTop: 12, display: "flex", flexDirection: "column", gap: 12, marginTop: "auto" } }, /* @__PURE__ */ React.createElement(Btn, { variant: "solid", dark, href: "contact.html", fullOnMobile: true }, "Start a project \u2192")))), !isMobile && open && /* @__PURE__ */ React.createElement("div", { onMouseEnter: () => {
