(() => {
  ...
  const EMAILJS_SERVICE_ID = "service_pumtwwd";
  ...
  const ContactForm = () => {
    ...
    const Pills = ({ value, options, onChange }) => {
      const { isMobile: isMobile2 } = useViewport();
      return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8 } }, options.map((o) => /* @__PURE__ */ React.createElement("button", { key: o, type: "button", onClick: () => onChange(o), style: { flex: isMobile2 ? "1 1 100%" : "0 0 auto", padding: "10px 14px", borderRadius: 999, border: `1px solid ${value === o ? "var(--ink)" : "var(--line)"}`, background: value === o ? "var(--ink)" : "var(--paper)", color: value === o ? "white" : "var(--ink)", fontSize: 13, cursor: "pointer", fontFamily: "inherit", transition: "all 0.15s", textAlign: "center" } }, o)));
    };
  ...
  const Body = () => {
    ...
    return /* @__PURE__ */ React.createElement("section", { style: { background: "var(--bg)", padding: isMobile ? "72px 20px 88px" : "100px 32px 120px", minHeight: "calc(100vh - 100px)" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: isTablet ? "1fr" : "1fr 1.4fr", gap: isMobile ? 36 : 80 } }, /* @__PURE__ */ React.createElement("div", { "data-reveal": true }, /* @__PURE__ */ React.createElement(Eyebrow, null, "Contact"), /* @__PURE__ */ React.createElement("h1", { style: { margin: "16px 0 24px", fontFamily: "'Space Grotesk', sans-serif", fontSize: clamp(40, "8vw", 64), fontWeight: 600, letterSpacing: clamp(-1.8, "-0.3vw", -2.5), lineHeight: 1 } }, "Tell us where it hurts."), /* @__PURE__ */ React.createElement("p", { style: { margin: 0, fontSize: 17, color: "var(--ink-2)", lineHeight: 1.55, maxWidth: 440 } }, "Most engagements start with a 45-minute call and a written diagnosis. Yours to keep, even if you don't move forward."), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 48, padding: "20px 22px", background: "var(--paper)", border: "1px solid var(--line)", borderRadius: 12 } }, /* @__PURE__ */ React.createElement(Mono, { color: "var(--signal)", size: 10 }, "Direct contact"), /* @__PURE__ */ React.createElement("p", { style: { margin: "10px 0 0", fontSize: 14, color: "var(--ink-2)", lineHeight: 1.55 } }, "Use the form on this page and we'll route the message to the right team.")), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 40, padding: "18px 20px", background: "var(--paper)", border: "1px solid var(--line)", borderRadius: 12 } }, /* @__PURE__ */ React.createElement(Mono, { color: "var(--signal)", size: 10 }, "Team model"), /* @__PURE__ */ React.createElement("p", { style: { margin: "10px 0 0", fontSize: 14, color: "var(--ink-2)", lineHeight: 1.55 } }, "Modx operates as a distributed team. Most projects begin remotely, with travel scoped only when the work requires it."))), /* @__PURE__ */ React.createElement("div", { "data-reveal": true }, /* @__PURE__ */ React.createElement(ContactForm, null))));
  };
